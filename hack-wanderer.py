...
def build_towers_snapshot(network, vendor):
    ...
    if reg:
        ...
        if reg_entry["rat"] in ("LTE", "CAT-M1", "CAT-NB1", "NB-IOT") and reg_entry["cell_id"] is not None:
            eci = reg_entry["cell_id"]
            reg_entry["eci"] = eci
            reg_entry["enodeb_id"] = eci >> 8
            reg_entry["sector_id"] = eci & 0xFF
